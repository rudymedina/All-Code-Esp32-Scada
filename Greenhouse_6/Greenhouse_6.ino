...
DeviceAddress termometr1 = { 0x28, 0xCC, 0x94, 0x79, 0x97, 0x15, 0x3, 0xCC };//19
DeviceAddress termometr2 = { 0x28, 0xE1, 0xD0, 0x7, 0xD6, 0x1, 0x3C, 0xC9 }; //20
