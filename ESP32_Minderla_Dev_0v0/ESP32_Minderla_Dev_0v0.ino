...
//--------------------------------------------|------|-----------|-------------------
String filenumberUpdate = "ESP32_Stas_Svetovaya_Dev_0v1.ino.esp32.bin";
//--------------------------------------------|------|-----------|-------------------
/////////////////////////////////////////////////////////////////////////////////////
//-------------------------------------------------------------------------|------|--
String UpdateServer = "http://fynjy8.beget.tech/ESP32/DarMal/Stasovoy/Svetovaya/";
//-------------------------------------------------------------------------|------|--
/////////////////////////////////////////////////////////////////////////////////////////
//-------------------------------|---------------------------------------------------
const String  MestoNazvanie = "Exp" ;
const String UstroystvoNazvanie = "Dev_0";
const String Upd = UpdateServer + filenumberUpdate;
//-------------------------------|---------------------------------------------------
////////////////////////////////////////////////////////////////////////////////////////
String GeoNazvanie = "Minderla";
String loadChanel = String("DarMal/") + String(GeoNazvanie) + String('/') + String(MestoNazvanie) + String('/') + String(UstroystvoNazvanie);// + String('/') + String(ZamerNazvanie);

const char *ssid_0 =  "Fresh";  // Имя вайфай точки доступа
const char *password_0 =  "OKM690wsx"; // Пароль от точки доступа

const char *ssid_1 =  "StrelaClub.ru"; // Имя вайфай точки доступа
const char *password_1 =  "660012660012"; // Пароль от точки доступа
...
DeviceAddress termometr1 = { 0x28, 0x3A, 0xB0, 0x7, 0xD6, 0x1, 0x3C, 0xE4 };// 9 
DeviceAddress termometr2 = { 0x28, 0x6A, 0x17, 0x7, 0xD6, 0x1, 0x3C, 0xA8 }; // 10
DeviceAddress termometr3 = { 0x28, 0x8A, 0xCC, 0x79, 0x97, 0x15, 0x3, 0xA0 }; // 11
...
void setup() {
  ...
  if ((WiFiMulti.run() == WL_CONNECTED)) {
    ...
    dht_0.setup(dhtPin_0, DHTesp::DHT22);
    dht_1.setup(dhtPin_1, DHTesp::DHT22);
