...
const char* mqttServer = "35.206.242.49";// "http://scada.darym.ru";  //"45.67.57.161";//"31.31.202.123";
...
DeviceAddress termometr1 = { 0x28, 0xA4, 0xF3, 0x79, 0x97, 0x13, 0x3, 0x44 };//28 A4 F3 79 97 13 3 44 termometer ID2
DeviceAddress termometr2 = { 0x28, 0x10, 0x18, 0x79, 0x97, 0x15, 0x3, 0x9F }; //28 10 18 79 97 15 3 9F termometer ID1
