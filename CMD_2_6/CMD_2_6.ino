...
const char *ssid_1 =  "Fresh"; // Имя вайфай точки доступа 
const char *password_1 =  "OKM690wsx"; // Пароль от точки доступа  //
...
DeviceAddress termometr1 = { 0x28, 0x44, 0x8A, 0x67, 0xD, 0x0, 0x0, 0xC7 };//11
DeviceAddress termometr2 = { 0x28, 0x24, 0x53, 0x67, 0xD, 0x0, 0x0, 0xA9 }; //12
