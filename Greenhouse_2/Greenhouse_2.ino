...
DeviceAddress termometr1 = { 0x28, 0x5, 0x52, 0x79, 0x97, 0x15, 0x3, 0x7B };//4
DeviceAddress termometr2 = { 0x28, 0xDE, 0x10, 0x79, 0x97, 0x15, 0x3, 0x2D }; //5
